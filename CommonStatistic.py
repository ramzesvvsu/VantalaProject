...
def print_statistic(file, div_list):
    ...
    div_list.Date = pd.to_datetime(div_list.Date) - pd.offsets.MonthBegin(1)
    ...
    result_list.append(
        [prev_row.DATE.to_datetime64(), prev_row.Qty, 0, 0, prev_row.Price, 0, prev_row.Cash,
         prev_row.Cash + prev_row.Qty*prev_row.Price])
...
if __name__ == '__main__':
    print_statistic('SBER_100101_200101.csv', pd.DataFrame.from_dict({'Date': ['13.06.2019',
                                                                               '26.06.2018',
                                                                               '14.06.2017',
                                                                               '14.06.2016',
                                                                               '15.06.2015',
